    ...
    <div className='w-screen h-screen flex justify-center items-center'>
        ...
        >
            <Form className='flex justify-center items-center flex-col w-80 gap-1 lg:w-[500px] mt-5 p-5'>
                ...
                <button type="submit" className="rounded-lg mt-2 bg-pink-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-pink-800 focus:outline-none focus:ring-4 focus:ring-pink-300 dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-800 w-[150px]">Ingresar</button>
                <p className='mt-2 text-sm'>¿No tienes cuenta? <Link to='/register'><span className='text-pink-700'>Crear Cuenta</span></Link></p>
            </Form>
        </Formik>
